...
export default async function PlatformPage() {
  ...
  const url = '/platform'
  const page: RequiredDataFromCollectionSlug<'pages'> | null = await queryPageBySlug({ slug: 'platform' })
  ...
  const pageUrl = `${siteUrl}/platform`
...
export async function generateMetadata(): Promise<Metadata> {
  const page = await queryPageBySlug({ slug: 'platform' })
