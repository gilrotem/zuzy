...
export default async function SolutionDetailPage({ params: paramsPromise }: Args) {
  ...
  const pageUrl = `${siteUrl}/solutions/${decodedSlug}`
  ...
  const breadcrumbItems = [
    ...
    { label: breadcrumbLabel, href: `/solutions/${decodedSlug}` },
  ]
