...
export default async function BrandDocsPage() {
  ...
  const url = '/brand-docs'

  const page: RequiredDataFromCollectionSlug<'pages'> | null = await queryPageBySlug({ slug: 'brand-docs' })
  ...
  const pageUrl = `${siteUrl}/brand-docs`
...
export async function generateMetadata(): Promise<Metadata> {
  const page = await queryPageBySlug({ slug: 'brand-docs' })
