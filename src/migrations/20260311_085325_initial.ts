...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('he', 'en', 'ru', 'ar', 'fr', 'es');
  ...
  CREATE TYPE "public"."enum_pages_blocks_code_language" AS ENUM('typescript', 'javascript', 'css', 'html');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_code_language" AS ENUM('typescript', 'javascript', 'css', 'html');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('he', 'en', 'ru', 'ar', 'fr', 'es');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('he', 'en', 'ru', 'ar', 'fr', 'es');
  CREATE TYPE "public"."enum_products_currency" AS ENUM('ILS', 'USD', 'EUR');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_version_currency" AS ENUM('ILS', 'USD', 'EUR');
  CREATE TYPE "public"."enum__products_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__products_v_published_locale" AS ENUM('he', 'en', 'ru', 'ar', 'fr', 'es');
  ...
  CREATE TYPE "public"."enum_site_settings_default_theme" AS ENUM('light', 'dark', 'auto');
  ...
  CREATE TABLE "pages_blocks_app_cost_calculator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_app_cost_calculator_locales" (
  	"title" varchar DEFAULT 'כמה יעלה לפתח את האפליקציה שלך?',
  	"subtitle" varchar DEFAULT 'קבל הערכת עלות מיידית על בסיס הדרישות שלך',
  	"cta_text" varchar DEFAULT 'רוצה הצעת מחיר מדויקת? דבר איתנו',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  );
  
  CREATE TABLE "pages_blocks_app_grid_block_apps" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "pages_blocks_app_grid_block_apps_locales" (
  	"title" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "pages_blocks_app_grid_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_app_grid_block_locales" (
  	"heading" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" varchar NOT NULL
  ...
  CREATE TABLE "_pages_v_blocks_app_cost_calculator" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_app_cost_calculator_locales" (
  	"title" varchar DEFAULT 'כמה יעלה לפתח את האפליקציה שלך?',
  	"subtitle" varchar DEFAULT 'קבל הערכת עלות מיידית על בסיס הדרישות שלך',
  	"cta_text" varchar DEFAULT 'רוצה הצעת מחיר מדויקת? דבר איתנו',
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_app_grid_block_apps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_app_grid_block_apps_locales" (
  	"title" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "_pages_v_blocks_app_grid_block" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_app_grid_block_locales" (
  	"heading" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "products" (
  	...
  	"price" numeric,
  	"currency" "enum_products_currency" DEFAULT 'ILS',
  	"grow_product_id" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"version_currency" "enum__products_v_version_currency" DEFAULT 'ILS',
  	"version_grow_product_id" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "site_settings" (
  	...
  	"logo_id" integer,
  	"favicon_id" integer,
  	"site_name" varchar DEFAULT 'ZUZY',
  	"default_theme" "enum_site_settings_default_theme" DEFAULT 'light',
  	"primary_color" varchar DEFAULT '#6750A4',
  	"accent_color" varchar DEFAULT '#4CA3C7',
  ...
  ALTER TABLE "pages_blocks_app_cost_calculator" ADD CONSTRAINT "pages_blocks_app_cost_calculator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_app_cost_calculator_locales" ADD CONSTRAINT "pages_blocks_app_cost_calculator_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_app_cost_calculator"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_app_grid_block_apps" ADD CONSTRAINT "pages_blocks_app_grid_block_apps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_app_grid_block"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_app_grid_block_apps_locales" ADD CONSTRAINT "pages_blocks_app_grid_block_apps_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_app_grid_block_apps"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_app_grid_block" ADD CONSTRAINT "pages_blocks_app_grid_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_app_grid_block_locales" ADD CONSTRAINT "pages_blocks_app_grid_block_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_app_grid_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_app_cost_calculator" ADD CONSTRAINT "_pages_v_blocks_app_cost_calculator_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_app_cost_calculator_locales" ADD CONSTRAINT "_pages_v_blocks_app_cost_calculator_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_app_cost_calculator"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_app_grid_block_apps" ADD CONSTRAINT "_pages_v_blocks_app_grid_block_apps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_app_grid_block"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_app_grid_block_apps_locales" ADD CONSTRAINT "_pages_v_blocks_app_grid_block_apps_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_app_grid_block_apps"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_app_grid_block" ADD CONSTRAINT "_pages_v_blocks_app_grid_block_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_app_grid_block_locales" ADD CONSTRAINT "_pages_v_blocks_app_grid_block_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_app_grid_block"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_app_cost_calculator_order_idx" ON "pages_blocks_app_cost_calculator" USING btree ("_order");
  CREATE INDEX "pages_blocks_app_cost_calculator_parent_id_idx" ON "pages_blocks_app_cost_calculator" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_app_cost_calculator_path_idx" ON "pages_blocks_app_cost_calculator" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_app_cost_calculator_locales_locale_parent_id_un" ON "pages_blocks_app_cost_calculator_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_app_grid_block_apps_order_idx" ON "pages_blocks_app_grid_block_apps" USING btree ("_order");
  CREATE INDEX "pages_blocks_app_grid_block_apps_parent_id_idx" ON "pages_blocks_app_grid_block_apps" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pages_blocks_app_grid_block_apps_locales_locale_parent_id_un" ON "pages_blocks_app_grid_block_apps_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "pages_blocks_app_grid_block_order_idx" ON "pages_blocks_app_grid_block" USING btree ("_order");
  CREATE INDEX "pages_blocks_app_grid_block_parent_id_idx" ON "pages_blocks_app_grid_block" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_app_grid_block_path_idx" ON "pages_blocks_app_grid_block" USING btree ("_path");
  CREATE UNIQUE INDEX "pages_blocks_app_grid_block_locales_locale_parent_id_unique" ON "pages_blocks_app_grid_block_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_app_cost_calculator_order_idx" ON "_pages_v_blocks_app_cost_calculator" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_app_cost_calculator_parent_id_idx" ON "_pages_v_blocks_app_cost_calculator" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_app_cost_calculator_path_idx" ON "_pages_v_blocks_app_cost_calculator" USING btree ("_path");
  CREATE UNIQUE INDEX "_pages_v_blocks_app_cost_calculator_locales_locale_parent_id" ON "_pages_v_blocks_app_cost_calculator_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_pages_v_blocks_app_grid_block_apps_order_idx" ON "_pages_v_blocks_app_grid_block_apps" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_app_grid_block_apps_parent_id_idx" ON "_pages_v_blocks_app_grid_block_apps" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "_pages_v_blocks_app_grid_block_apps_locales_locale_parent_id" ON "_pages_v_blocks_app_grid_block_apps_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_pages_v_blocks_app_grid_block_order_idx" ON "_pages_v_blocks_app_grid_block" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_app_grid_block_parent_id_idx" ON "_pages_v_blocks_app_grid_block" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_app_grid_block_path_idx" ON "_pages_v_blocks_app_grid_block" USING btree ("_path");
  CREATE UNIQUE INDEX "_pages_v_blocks_app_grid_block_locales_locale_parent_id_uniq" ON "_pages_v_blocks_app_grid_block_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_app_cost_calculator" CASCADE;
  DROP TABLE "pages_blocks_app_cost_calculator_locales" CASCADE;
  DROP TABLE "pages_blocks_app_grid_block_apps" CASCADE;
  DROP TABLE "pages_blocks_app_grid_block_apps_locales" CASCADE;
  DROP TABLE "pages_blocks_app_grid_block" CASCADE;
  DROP TABLE "pages_blocks_app_grid_block_locales" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_app_cost_calculator" CASCADE;
  DROP TABLE "_pages_v_blocks_app_cost_calculator_locales" CASCADE;
  DROP TABLE "_pages_v_blocks_app_grid_block_apps" CASCADE;
  DROP TABLE "_pages_v_blocks_app_grid_block_apps_locales" CASCADE;
  DROP TABLE "_pages_v_blocks_app_grid_block" CASCADE;
  DROP TABLE "_pages_v_blocks_app_grid_block_locales" CASCADE;
